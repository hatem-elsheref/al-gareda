                        ...
                        <form role="form" method="post" action="{{route('users.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" placeholder="ادخل البريد الالكترونى" value="{{old('email')}}">
                                </div>
                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group pull-right" style="margin-left: 10px">
                                                                        <div class="checkbox-inline">
                                                                            <input type="checkbox" id="{{strtolower($map[$crud_key].'_'.$key)}}$crud_operation.$key}}" value="{{strtolower($map[$crud_key].'_'.$key)}}" name="permissions[]"
                                                                                {{(in_array(strtolower($map[$crud_key].'_'.$key),(array)old('permissions')))?'checked':''}}>
