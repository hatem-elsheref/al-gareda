...
(function (window, document, undefined) {
    ...
    var factory = function ($, DataTable) {
        ...
        FixedColumns.prototype = /** @lends FixedColumns.prototype */{
            ...
            /**
             * Get data users information about a row or cell in the table body.
             * This function is functionally identical to fnGetPosition in DataTables,
             * taking the same parameter (TH, TD or TR node) and returning exactly the
             * the same information (data users information). THe difference between
             * the two is that this method takes into account the fixed columns in the
             * table, so you can pass in nodes from the master table, or the cloned
             * tables and get the users position for the data in the main table.
             *  @param {node} node TR, TH or TD element to get the information about
             *  @returns {int} If nNode is given as a TR, then a single users is
             *    returned, or if given as a cell, an array of [row users, column users
             *    (visible), column users (all)] is given.
             */
