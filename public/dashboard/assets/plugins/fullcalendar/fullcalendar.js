...
----------------------------------------------------------------------------------------------------------------------*/
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Given a cell object with users and misc data, generates a range object
    ...
    DayGrid.mixin({
        ...
        buildSegLevels: function (segs) {
            ...
            for (i = 0; i < segs.length; i++) {
                ...
                // `j` now holds the desired subrow users
                seg.level = j;
...
----------------------------------------------------------------------------------------------------------------------*/
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        computeTimeTop: function (time) {
            ...
            slatIndex = Math.floor(slatCoverage); // an integer users of the furthest whole slot
    ...
    TimeGrid.mixin({
        ...
        renderSegTable: function (segs) {
            ...
            for (col = 0; col < segCols.length; col++) { // iterate each column grouping
                colSegs = segCols[col];
                placeSlotSegs(colSegs); // compute horizontal coordinates, z-users's, and reorder the array
...
----------------------------------------------------------------------------------------------------------------------*/
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        initHiddenDays: function () {
            ...
            var isHiddenDayHash = []; // is the day-of-week hidden? (hash with day-of-week-users -> bool)
            var dayCnt = 0;
            var i;
        ...
        // `day` is a day-of-week users (0-6), or a Moment
