...
<option selected value="حيادى" @if(old('status')=='حيادى') selected @endif>حيادى</option>
<option value="جيد" @if(old('status')=='جيد') selected @endif>جيد</option>
<option value="سيئ" @if(old('status')=='سيئ') selected @endif>سيئ</option>
