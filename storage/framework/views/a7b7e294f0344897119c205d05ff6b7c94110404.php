    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo e(route('newspapers.index')); ?>">
                        الجرائد
                    </a></li>
                <li class="active">
                    اضافة جريده جديده
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <!-- form start -->
                        <form role="form" method="post" action="<?php echo e(route('newspapers.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="box-body">
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/el-sheref/Private/cv-works/gareda/resources/views/dashboard/newspapers/create.blade.php ENDPATH**/ ?>