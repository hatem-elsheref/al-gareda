    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                المشرفين
                <small>
                    <span class="badge btn-danger btn-sm"><?php echo e(count($users)); ?></span>
                </small>
                    ...
                    <form method="get" action="<?php echo e(route('users.index')); ?>">
                        ...
                        <div class="col-md-5">
                            ...
                            <?php if(auth()->user()->hasPermission('create_users')): ?>
                                <a href="<?php echo e(route('users.create')); ?>" class="brn btn-sm btn-danger"><span class="fa fa-plus"></span> اضافة مشرف جديد </a>
                               <?php else: ?>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($user->roles[0]->name); ?></td>
                                            <td style="text-align: center"><img src="<?php echo e(url('storage/users/'.$user->photo)); ?>" style="width: 60px;height: 60px;"></td>
                                            <td>
                                                <?php if(auth()->user()->hasPermission('delete_users')): ?>
                                                <form method="post" id="remove_user_form_<?php echo e($user->id); ?>" action="<?php echo e(route('users.destroy',$user->id)); ?>">
                                               ...
                                               <?php else: ?>
                                                ...
                                                <a href="<?php echo e(route('users.edit',$user->id)); ?>" class="btn btn-sm btn-success"><i class="fa fa-edit"></i> تعديل</a>
                                                    <?php else: ?>
                            ...
                            <?php echo $users->appends(['search'=>request()->query('search')])->render(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/el-sheref/Private/cv-works/gareda/resources/views/dashboard/users/index.blade.php ENDPATH**/ ?>