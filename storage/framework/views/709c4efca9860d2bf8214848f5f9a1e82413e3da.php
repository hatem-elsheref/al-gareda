    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                الكلمات المفتاحية
                <small>
                    <span class="badge btn-danger btn-sm"><?php echo e(count($tags)); ?></span>
                </small>

            </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo e(route('dashboard')); ?>"><i class="fa fa-dashboard"></i> اللوحة الرئيسيه</a></li>
                <li class="active">الكلمات المفتاحية</li>
        ...
        <section class="content">
            <div class="row mb-4">
                <div class="col-md-7  mr-bottom-10">
                    <form method="get" action="<?php echo e(route('tags.index')); ?>">
                        ...
                        <div class="col-md-5">
                            ...
                            <?php if(auth()->user()->hasPermission('create_tags')): ?>
                                <a href="<?php echo e(route('tags.create')); ?>" class="brn btn-sm btn-danger"><span class="fa fa-plus"></span> اضافة كلمه مفتاحية جديده </a>
                            <?php else: ?>
                                <a href="#" disabled="" class="brn btn-sm btn-danger"><span class="fa fa-plus"></span> اضافه كلمه مفتاحية جديده </a>
                            <?php endif; ?>
                        </div>
                    </form>
                </div>
                        ...
                        <div class="box-body">
                            <table class="table table-bordered">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($user->id); ?>.</td>
                                            <td><?php echo e($user->name); ?></td>
                                            <td>
                                                <?php if(auth()->user()->hasPermission('delete_tags')): ?>
                                                    <form method="post" id="remove_user_form_<?php echo e($user->id); ?>" action="<?php echo e(route('tags.destroy',$user->id)); ?>">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <h4 class="modal-title">حذف كلمة مفتاحية</h4>
                                                                </div>
                                                ...
                                                <?php if(auth()->user()->hasPermission('update_tags')): ?>
                                                    <a href="<?php echo e(route('tags.edit',$user->id)); ?>" class="btn btn-sm btn-success"><i class="fa fa-edit"></i> تعديل</a>
                                                <?php else: ?>
                            ...
                            <?php echo $tags->appends(['search'=>request()->query('search')])->render(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/el-sheref/Private/cv-works/gareda/resources/views/dashboard/tags/index.blade.php ENDPATH**/ ?>